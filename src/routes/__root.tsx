...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Photography With Cam" },
      { name: "description", content: "Professional photography by Abul Khair — capturing real moments and emotions." },
      { name: "author", content: "Abul Khair" },
      { name: "theme-color", content: "#1a6ef5" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "PWC" },
